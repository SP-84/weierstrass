...
\usepackage{xcolor} % Use mathcolor to highlight symbols
\usepackage[colorlinks, colorlinks=blue]{hyperref} % Use hyprlinks
...
\usepackage[backend=biber, style=alphabetic]{biblatex} % Simple bibliography usage with biber
